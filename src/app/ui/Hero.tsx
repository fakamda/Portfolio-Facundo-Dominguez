  ...
  return (
    <div className="mt-6">
      <div className="flex sm:flex-row flex-col justify-center items-center gap-6 md:justify-between lg:justify-center md:mx-10 mx-5">
        ...
        <h2 className="text-4xl font-bold tracking-tighter sm:text-4xl md:text-6xl">Hola<span className="text-pink-400">.</span></h2>
        <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl mt-1">Soy Facundo Dominguez</h2>
