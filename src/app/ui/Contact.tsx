...
const Contact = () => {
  ...
  return (
    <div className="flex flex-col justify-center items-center gap-5 m-20">
      ...
      <div className="flex flex-col justify-center items-center gap-3 isolate aspect-video sm:w-[460px] min-h-[510px] rounded-xl bg-white/20 shadow-lg ring-1 ring-black/5">
